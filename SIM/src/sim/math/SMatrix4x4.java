...
public class SMatrix4x4 {
   ...
   * 
	...
	/**
   * <p>
   * Méthode pour obtenir une matrice de transformation linéaire de rotation Ru autour d'un axe <i>u</i> quelconque
   * <b>par rapport à l'origine</b> d'un système d'axe cartésien <i>xyz</i> si la matrice est utilisée dans l'ordre
   * <ul>v1 = Ru * v0</ul>
   * où v0 est le vecteur à transformer et v1 est le vecteur transformé. Dans la littérature, cette matrice porte le
   ...
   * @throws SImpossibleNormalizationException Si l'axe de rotation <i>u</i> ne peut pas être normalisé.
   */
