...
public class SModelReader extends SAbstractReadable implements SReader {
  ...
  private SModel transformModel(SModel model)
  {
    ...
    // Paramètre déterminant si une transformation de la géométrie de la primitive est nécessaire
    boolean transformation_required = !(scale.equals(SModel.DEFAULT_SCALE) && rotation.equals(SModel.DEFAULT_ROTATION) && translation.equals(SModel.DEFAULT_TRANSLATION));
    ...
    for(SPrimitive p : list)
    {
      ...
      try{
          ...
          // Une seule interprétation des coordonnée uv sera possible. Ce sera la première définition qui sera retenue.
          ...
          // Ajouter la nouvelle géométrie dans une nouvelle primitive et l'injecter dans le modèle. 
          if(transformation_required)
